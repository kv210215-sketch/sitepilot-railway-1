...
**Operator account:** `$DEMO_EMAIL` / `$DEMO_PASSWORD` — *not stored in repo; provide via env (`DEMO_EMAIL`/`DEMO_PASSWORD`, see `demo/solomiya/.env.example`) or Railway / secure note.*
